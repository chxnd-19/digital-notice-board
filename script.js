document.addEventListener("DOMContentLoaded", () => {
    ...
    const pinInputEl = document.getElementById("adminPinInput");
    if (pinInputEl) {
        ...
        targetContainer.innerHTML = data.map(n => {
            ...
            return `
                <div class="card">
                    ...
                    <button onclick="viewImage('${n.file_url}', '${n.title.replace(/'/g, "\\'")}')" class="btn-download" style="border:none; cursor:pointer;">
                        View Document
                    </button>
                    ${adminActions}
                </div>`;
    ...
    if (cancelBtn) {
        cancelBtn.onclick = () => {
            ...
            document.getElementById("uploadBtn").innerText = "Publish to Board";
